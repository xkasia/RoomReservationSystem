...
//    }
    ...
    public void addUser(String firstName, String lastName, String password, String login, HttpServletResponse response) throws IOException {
    ...
    public String updateRoom(String name, String location,Integer numberOfSeats,
        ...
        roomsService.updateRoom(roomDTO, name, location, numberOfSeats, projector, phoneNumber);
    ...
    public void addRoom(String name, String location,Integer numberOfSeats,
                        String projector, String phoneNumber, HttpServletResponse response) throws IOException {
        boolean checkIfRoomExists = roomsService.checkIfRoomExists(name);

        if(checkIfRoomExists){
            response.sendError(401, "Such room exists in our system. Please try again.");
            return;
        }
